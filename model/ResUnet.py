...
from keras.layers import Input, concatenate, Conv2D, MaxPooling2D, Conv2DTranspose, Activation, add, UpSampling2D
...
def ResUnet(num_classes, input_shape, lr_init, lr_decay):
    ...
    x = Conv2D(num_classes, (3, 3), activation='sigmoid', padding='same')(output9)
