...
# network structure
def Multpoolunet_3(num_classes, input_shape, lr_init, lr_decay, vgg_weight_path=None):
    # input layer
    # ============================================================================
    ...
    # x12 = Conv2D(64, kernel_size=(8, 8),  strides=(8, 8))(x)
    # x1 = concatenate([x1, x12])
    ...
    # x22 = Conv2D(64, kernel_size=(4, 4),  strides=(4, 4))(x)
    ...
    # x33 = Conv2D(64, kernel_size=(2, 2),  strides=(2, 2))(x)
    # x3 = concatenate([x3, x33])

    productlayer4 = PSAModule(x, 128, 128, 256, 512)
    x = MaxPooling2D()(productlayer4)

    # Block 5
    x = PSAModule(x, 128, 128, 256, 512)
