...
# network structure
def Multpoolunet_5(num_classes, input_shape, lr_init, lr_decay, vgg_weight_path=None):
    # input layer
    # ============================================================================
    ...
    x = BatchNormalization()(x)
    x = Activation('relu')(x)
    productlayer1 = ECAWeightModule(x)
    ...
    x = BatchNormalization()(x)
    x = Activation('relu')(x)
    productlayer2 = ECAWeightModule(x)
    ...
    x = BatchNormalization()(x)
    x = Activation('relu')(x)
    productlayer3 = ECAWeightModule(x)
    ...
    x = BatchNormalization()(x)
    x = Activation('relu')(x)
    productlayer4 = ECAWeightModule(x)
